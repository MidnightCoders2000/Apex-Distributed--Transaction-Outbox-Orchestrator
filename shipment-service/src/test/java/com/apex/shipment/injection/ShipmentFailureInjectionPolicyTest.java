...
class ShipmentFailureInjectionPolicyTest {
    ...
    void triggerAccountAlwaysFailsRegardlessOfRate() {
        ...
        ShipmentFailureInjectionPolicy policy = new ShipmentFailureInjectionPolicy(props, fixed(0.99));
    ...
    void nonTriggerAccountFailsWhenRandomBelowRate() {
        ...
        ShipmentFailureInjectionPolicy policy = new ShipmentFailureInjectionPolicy(props, fixed(0.3));
    ...
    void nonTriggerAccountSucceedsWhenRandomAtOrAboveRate() {
        FailureInjectionProperties props = new FailureInjectionProperties(0.5, List.of());
        ShipmentFailureInjectionPolicy policy = new ShipmentFailureInjectionPolicy(props, fixed(0.5));
    ...
    void zeroRateAndNoTriggerNeverFails() {
        ...
        ShipmentFailureInjectionPolicy policy = new ShipmentFailureInjectionPolicy(props, fixed(0.0));
